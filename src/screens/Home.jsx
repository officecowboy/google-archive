      ...
      <div className="home-content">
        ...
        <div className="about-container">
          <div className="about">
            ...
            <ol>
              <li>Enter a date from January 1, 2000 - April 1, 2022 to view all articles published in <a href="https://www.nytimes.com/section/technology" target="blank">The New York Times</a> Technology Section on that day.</li>
